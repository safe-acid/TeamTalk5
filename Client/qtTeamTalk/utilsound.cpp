...
QString getSoundEventFilename(SoundEvent event)
{
    ...
    if (ttSettings->value(SETTINGS_SOUNDEVENT_ENABLE, SETTINGS_SOUNDEVENT_ENABLE_DEFAULT).toBool())
    {
        ...
        case SOUNDEVENT_HOTKEY:
            ...
            break;
        case SOUNDEVENT_HOTKEY_RELEASED:
            filename = ttSettings->value(SETTINGS_SOUNDEVENT_HOTKEY_RELEASED, SETTINGS_SOUNDEVENT_HOTKEY_RELEASED_DEFAULT).toString();
            break;
...
void resetDefaultSoundsPack()
{
    ...
    ttSettings->setValue(SETTINGS_SOUNDEVENT_HOTKEY_RELEASED, SETTINGS_SOUNDEVENT_HOTKEY_RELEASED_DEFAULT);
